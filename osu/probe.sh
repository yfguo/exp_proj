...
pushd ${BENCH_DIR}
# echo "INTRA SOCKET"
$MPICH_HOME/bin/mpiexec -bind-to user:0,1 -n 2 ./c/mpi/pt2pt/standard/${BIN} ${PARMS}

# echo "INTER SOCKET"
# $MPICH_HOME/bin/mpiexec -bind-to user:0,28 -n 2 ./c/mpi/pt2pt/standard/${BIN} ${PARMS}
popd
